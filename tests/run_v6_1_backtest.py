"""
Standalone backtest runner for AFC Downtrend v6.1
"""
...
# ── Load v6.1 strategy ──
strategy_path = os.path.join(os.path.dirname(__file__), '..', 'strategies', 'afc_downtrend_v6_1.py')
...
# ── Results ──
print("\n" + "="*60)
print("BACKTEST RESULTS - AFC Downtrend v6.1")
print("="*60)

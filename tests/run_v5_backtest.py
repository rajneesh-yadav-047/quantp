"""
Standalone backtest runner for AFC Momentum v5.0
"""
...
# ── Load v5 strategy ──
strategy_path = os.path.join(os.path.dirname(__file__), '..', 'strategies', 'afc_momentum_v5.py')
...
engine = BacktestEngine(
    ...
    max_position_size=20,  # allow 10 long + 10 short flip
    log_dir="./logs",
...
# ── Results ──
print("\n" + "="*60)
print("BACKTEST RESULTS - AFC Momentum v5.0")
print("="*60)

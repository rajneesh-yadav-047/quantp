"""
Standalone backtest runner for AFC Momentum v5.1
"""
...
# ── Load v5.1 strategy ──
strategy_path = os.path.join(os.path.dirname(__file__), '..', 'strategies', 'afc_momentum_v5_1.py')
...
engine = BacktestEngine(
    ...
    max_position_size=100,  # allow 50 long + 50 short flip
    log_dir="./logs",
...
# ── Results ──
print("\n" + "="*60)
print("BACKTEST RESULTS - AFC Momentum v5.1")
print("="*60)

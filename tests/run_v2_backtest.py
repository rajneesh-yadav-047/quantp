"""
Standalone backtest runner for AFC Mean Reversion v2.0
"""
...
# ── Load v2 strategy ──
strategy_path = os.path.join(os.path.dirname(__file__), '..', 'strategies', 'afc_mean_reversion_v2.py')
...
# ── Results ──
print("\n" + "="*60)
print("BACKTEST RESULTS — AFC Mean Reversion v2.0")
print("="*60)

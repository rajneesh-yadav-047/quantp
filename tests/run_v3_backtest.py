"""
Standalone backtest runner for AFC Mean Reversion v3.0
"""
...
# ── Load v3 strategy ──
strategy_path = os.path.join(os.path.dirname(__file__), '..', 'strategies', 'afc_mean_reversion_v3.py')
...
# ── Results ──
print("\n" + "="*60)
print("BACKTEST RESULTS - AFC Mean Reversion v3.0")
print("="*60)

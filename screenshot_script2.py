...
tabs = [
    ...
    ('strategy-registry', 'STRATEGY REGISTRY', '07_strategy_registry'),
    ('research', 'RESEARCH LAB', '08_research_lab'),
    ('multi-asset', 'MULTI-ASSET', '09_multi_asset'),
    ('portfolio-risk', 'PORTFOLIO RISK', '10_portfolio_risk'),
    ('optimizer', 'OPTIMIZER', '11_optimizer'),
    ('cleanup', 'CLEANUP', '12_cleanup'),
]

for tab_id, tab_name, filename in tabs:
    # Use evaluate to dispatch a real mouse event
    click_code = f"""
    (() => {{
